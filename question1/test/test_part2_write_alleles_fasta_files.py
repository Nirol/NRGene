...
import part2_write_alleles_fasta_files
...
class TestPart2CreateFasta(unittest.TestCase):
    ...
    def test__cut_seq_length_recursive_lines_num(self):
        inlength_sequences = []
        sequence = "x" * (80*5 + 3)
        part2_write_alleles_fasta_files._cut_seq_length_recursive(inlength_sequences, sequence)
    ...
    def test__cut_seq_length_recursive_short(self):
        inlength_sequences = []
        sequence = "x" * 5
        part2_write_alleles_fasta_files._cut_seq_length_recursive(
